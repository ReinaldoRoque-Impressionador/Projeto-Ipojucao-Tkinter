...
from dados_compartilhados import usuarios, som_global_ativo, usuario_atual
try:
...
def barra_audio(frame_pai):
    ...
    btn_trilha = ttk.Button(barra, text="🎶 Tocar Trilha", command=lambda: tocar_musica("sons/abertura.mp3"))
